...
class TimePlot():
    ...
    def plotrateby_tag(self, obdclass, stats_type, events, tag):        
        if "statfs" in events:
            label = "iops"
            scale = 1.0
...
def home(request):
    ...
    field["mds_script"], field["mds_div"] = components(P.plotrateby_tag("mds", "mds", iops_tuples, "client_hostname"))
    field["oss_script"], field["oss_div"] = components(P.plotrateby_tag("oss", "oss", bw_tuples, "client_hostname"))
